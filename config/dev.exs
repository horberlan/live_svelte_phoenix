...
config :live_svelte_pheonix, LiveSveltePheonixWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "20On9yYdVwUt8rtkRHGHaeUtSdDpnaBlQVip4JT26V2xJWxgz/RUl3OXAELA/yu3",
  watchers: [
...
config :live_svelte_pheonix, LiveSveltePheonixWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/live_svelte_pheonix_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :live_svelte_pheonix, dev_routes: true
